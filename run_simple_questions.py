        ...
        for epoch in t:
            ...
            for batch in range(batch_num):
                ...
                if task_index > 0:
                    ...
                    # curriculum_rel_list = []
                    # while len(curriculum_rel_list) < opt.curriculum_rel_num:
                    #     one_curriculum_rel = random.sample(seen_relations, 1)[0]
                    #     if len(train_data_dict[one_curriculum_rel]) >= opt.curriculum_instance_num:
                    #         curriculum_rel_list.append(one_curriculum_rel)
                    #
                    ...
                    curriculum_instance_list = []
                    for curriculum_rel in curriculum_rel_list:
                        if len(train_data_dict[curriculum_rel]) >= opt.curriculum_instance_num:
                            curriculum_instance_list.extend(random.sample(train_data_dict[curriculum_rel], opt.curriculum_instance_num))
                        else:
                            curriculum_instance_list.extend(train_data_dict[curriculum_rel])
