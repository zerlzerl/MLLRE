...
mllre_tsne = TSNE(n_components=2, random_state=317).fit_transform(mllre_rel_embeddings[-1])
curriculum_tsne = TSNE(n_components=2, random_state=226).fit_transform(curriculum_rel_embeddings[-1])
